...
update public.negocio_configuracion c
set logo_url = 'saborlatinologo.png'
from public.negocios n
where n.id = c.negocio_id
  and n.slug = 'sabor-latino'
  and nullif(btrim(c.logo_url), '') is null;

drop function if exists public.platform_admin_create_business(
